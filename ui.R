...
ui <- dashboardPage(
  ...
  # ---------- HEADER ----------
  dashboardHeader(
    title = span("🧬 Multiome Priming", style = "font-weight:600; color:white;"),
    titleWidth = 280
  ),
      ...
      tabItem(
        ...
        fluidRow(
          box(
            ...
            fileInput(
              "datafile",
              "Upload preprocessed Seurat or Multiome object (.rds)",
              accept = c(".rds")
            ),
          ...
          box(
            title = "Welcome to Multiome Priming!",
            width = 8,
            solidHeader = TRUE,
            status = "info",
            
            p("Multiome Priming quantifies evolutionary, functional, and regulatory potential of individual cells in single-cell datasets. 
               RNA modules support scRNA-seq analysis, while the Multiome Priming module supports paired RNA + ATAC analysis."),
